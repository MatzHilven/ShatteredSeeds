package me.matzhilven.shatteredseeds.schematic;

import me.matzhilven.shatteredseeds.schematic.blockentity.BlockEntity;
import me.matzhilven.shatteredseeds.schematic.blockentity.BlockEntityType;
...
public class Schematic {
     ...
     */
    public Schematic(String farmID, String absolutePath) {
        this.farmID = farmID;
    ...
    public int getAirIndex() {
        ...
        for (Map.Entry<Integer, BlockData> entry : blockPalette.entrySet()) {
